<template>
    <button class="btn btn-secondary text-nowrap" :disabled="!!item.slotsMax && !item.isHaveSlotsAvailable">
        <span>+</span>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-textarea"
            viewBox="0 0 16 16">
            <path
