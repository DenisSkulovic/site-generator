<template>
    <div>
        ...
        <CheckBoxField :label="'Async'" :value="props.asset.isAsync"
            @change="(newVal) => handleChange('isAsync', newVal)"></CheckBoxField>
        <CheckBoxField :label="'Defer'" :value="props.asset.isDefer"
            @change="(newVal) => handleChange('isDefer', newVal)"></CheckBoxField>
...
import { ScriptAsset, AssetPositionEnum, AssetRelEnum } from '@page_cls_module';
