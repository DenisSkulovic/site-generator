...
const createFooterHTMLObject = ({ uuid = "123", html = "<div>Footer</div>", content = (0, exports.createFooterContent)({}), config = (0, exports.createFooterConfig)({}), metadata = createFooterHTMLMetadata({}) }) => new DTO.FooterHTMLObject(uuid, html, content, config, metadata);
exports.createFooterHTMLObject = createFooterHTMLObject;
const createHeaderHTMLObject = ({ uuid = "123", html = "<div>Header</div>", config = (0, exports.createHeaderConfig)({}), content = (0, exports.createHeaderContent)({}), metadata = createHeaderHTMLMetadata({}) }) => new DTO.HeaderHTMLObject(uuid, html, config, content, metadata);
