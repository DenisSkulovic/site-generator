...
const buildPageConfig = (obj) => {
    ...
    const pageConfig = new PageConfig(obj.uuid, lang, obj.pageName, obj.contentId, Boolean(obj.isIncludeBootstrap), obj.headVersion, bootstrapVersion, templateVersion, obj.headerId, areaConfigArr, obj.footerId, metadata);
    return pageConfig;
};
