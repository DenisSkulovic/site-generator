...
export interface IProductRepository {
    getProduct(id: string): Promise<DTO.Product>
    createProduct(config: DTO.Product): Promise<boolean>
    updateProduct(id: string, config: DTO.Product): Promise<boolean>
}
...
export class ProductRepository implements IProductRepository {
    ...
    createProduct(product: DTO.Product): Promise<boolean>{
        return new Promise((resolve) => {
    ...
    updateProduct(product: DTO.Product): Promise<boolean>{
        return new Promise((resolve) => {
            const params: AWS.DynamoDB.DocumentClient.UpdateItemInput = ProductRepository.getUpdateItemParams(this.tableName, JSON.parse(JSON.stringify(state)), token)
    ...
    static unmarshallState(obj: LooseObject) { // TODO use real fields
        ...
        return ProductRepository.deleteUndefinedFields({
            token,
            creationDate,
            updateDate,
            request,
